...
public class ActivityChangeLog extends ChangeLog {
	 ...
	 */
	public static ChangeLog getLogsForCreateActivity(Activity newActivityInfo) {
	...
	*/
	public static ChangeLog getLogsForDeleteActivity(Activity oldActivityInfo, User deletingUser) {
