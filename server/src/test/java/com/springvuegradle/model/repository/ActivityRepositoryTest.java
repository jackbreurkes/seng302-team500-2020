...
class ActivityRepositoryTest {
    ...
    @Test
    public void deleteActivity_CascadesPinDeletion() {
        Activity activity = new Activity("Test Activity", false, "New Zealand", testCreator, Collections.singleton(testActivityType));
        ActivityPin pin = new ActivityPin(activity, 0, 0, 0, 0, 0, 0);
        ...
        assertTrue(savedCreator.isPresent());
        assertTrue(savedActivityType.isPresent());
        assertFalse(activityPinRepository.existsById(savedActivity.getActivityPin().getPin_id()));
    }
